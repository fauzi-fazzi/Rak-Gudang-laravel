                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table">
                                    <table class="table table-striped" style="font-size: 12px;" id="table-satuan">
                                        <thead>
                                            <tr>
                                                <th class="text-center" style="width: 5%;">#</th>
                                                <th style="width: 50px;">Nama Satuan</th>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('master/satuan/store') }}" enctype="multipart/form-data"
                                        method="POST">
                                        @csrf
