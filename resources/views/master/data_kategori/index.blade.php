                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table">
                                    <table class="table table-striped" style="font-size: 12px;" id="table-kategori">
                                        <thead>
                                            <tr>
                                                <th class="text-center" style="width: 5%;">#</th>
                                                <th style="width: 50px;">Nama Kategori</th>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('kategori.store') }}" enctype="multipart/form-data"
                                        method="POST">
                                        @csrf
