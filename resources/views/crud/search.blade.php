    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header text-center">
                <div class="section-header-back" style="display: flex; justify-content: center; align-items: center;">
                    <a href="{{ url('rak') }}" class="btn btn-danger mr-3"><i class="fas fa-arrow-left"></i> Kembali</a>
                    <h1 class="mb-0">Pencarian " {{ $search }} "</h1>
                </div>
            </div>
                                                    ...
                                                    <td style="white-space: nowrap;">
                                                        ...
                                                        @if (Auth::user())
                                                            <a class="btn btn-primary btn-action mr-1"
                                                                href="{{ url('rak/' . $item->rak->id . '/edit/' . $item->id) }}"
